...
private:
  void StartUp_() override {
    ...
    glUniform3fv(glGetUniformLocation(rendering_program_, "u_light_pos"), 1, glm::value_ptr(light_pos_));
    glUniform3fv(glGetUniformLocation(rendering_program_, "u_light_color"), 1, glm::value_ptr(light_color_));
  }
  ...
  void Draw__(double current_time) {
    ...
    glUniform3f(glGetUniformLocation(rendering_program_, "u_color"),
                0.0, 0.0, sin(glm::radians(angle)));
    ...
    glUniform3fv(glGetUniformLocation(rendering_program_, "u_camera_pos"),
                 1, glm::value_ptr(camera_pos_));
